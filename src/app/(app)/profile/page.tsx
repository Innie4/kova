      ...
      <Card className="rounded-[30px] border border-white/70 bg-white/85 shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
        ...
        <CardContent className="space-y-4 px-6 pb-6">
          <div className="space-y-2">
            ...
            <Input defaultValue={demoUser.name} className="rounded-2xl border-slate-200 bg-slate-50" />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700">Phone</label>
            <Input defaultValue={demoUser.phone} className="rounded-2xl border-slate-200 bg-slate-50" />
          </div>
          <div className="space-y-2">
          ...
          <div className="rounded-[24px] border border-emerald-200 bg-emerald-50 p-4">
            ...
            <p className="mt-2 text-2xl font-semibold text-emerald-800">Verified</p>
          </div>
            ...
            {demoRecipients.map((recipient) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="ghost" className="rounded-full px-4 text-rose-600">
                    Delete
                  </Button>
                </div>
              </div>
        ...
        <Card className="rounded-[30px] border border-rose-200 bg-[linear-gradient(180deg,#fff7f7_0%,#fff1f1_100%)] shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
          <CardContent className="px-6 py-6">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
              This removes the user profile, saved recipients, and KYC records from
              the app experience. On-chain attestations remain public as historical proofs.
            </p>
